    ...
    <section className='pt-8 pb-16'>
      <div className='mx-6 xl:max-w-[1200px] xl:mx-auto'>
        <div className='mb-12 flex flex-col gap-y-6 md:flex-row md:justify-between md:items-center'>
          <div className='flex items-center py-4 px-6 bg-white rounded-lg shadow-md md:w-[400px] lg:w-[500px]'>
          ...
          <div className='relative'>
            <div
              className='flex items-center justify-between px-6 bg-white shadow-md rounded-lg py-4 md:cursor-pointer md:w-[240px]'
            ...
            <div
              className='bg-white shadow-md rounded-lg px-6 py-4 absolute left-0 top-16 w-full z-40'
